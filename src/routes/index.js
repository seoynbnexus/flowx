...
import metaWebhookRoutes from '../modules/campaigns/meta-webhook.routes.js';
import metaWebhookAdminRoutes from '../modules/campaigns/meta-webhook-admin.routes.js';
...
router.use('/meta/webhook', metaWebhookRoutes);
router.use('/admin/meta', metaWebhookAdminRoutes);
