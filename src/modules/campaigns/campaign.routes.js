...
router.post('/media/check', authenticate, requireRole('client', 'super_admin'), validate(checkCampaignMediaSchema), controller.checkCampaignMedia)
...
router.post('/:id/reopen', authenticate, requireRole('client', 'super_admin'), controller.reopenCampaign)
router.put('/:id/creative', authenticate, requireRole('client', 'super_admin'), validate(creativeSchema), controller.saveCreative)
router.post('/:id/creative-amendment', authenticate, requireRole('client', 'super_admin'), validate(creativeSchema), controller.requestCreativeAmendment)
